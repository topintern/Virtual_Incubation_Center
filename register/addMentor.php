...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item"><a class="nav-link" href="addUser.php"><span class="fa fa-info fa-lg"></span> Register User</a></li>
                    <li class="nav-item"><a class="nav-link" href="./addInvestor.php"><span class="fa fa-info fa-lg"></span> Register Investor</a></li>
                    <li class="nav-item active"><a class="nav-link" href="#"><span class="fa fa-info fa-lg"></span> Register Mentor</a></li>
                </ul>
    ...
    <br>
    <div class="container">
        <form action="insertMentors.php" method="POST">
            <table cellpadding="6" cellspacing="12"  width="80%">
                <tr>
                    <th style="color:blue">Add a VIC Mentor:</th>
                </tr>
                <tr>
                    <td class="txt"><b>Enter name of the mentor:</b></td>
                    <td>
                        <input type="text" id="name" name="name"  size="25" required>
                    </td>
                </tr>
                <tr>
                    <td class="txt"><b>Enter mentor email:</b>(username)</td>
                    <td><input type="email" id="email" name="email" size="25" required></td>
                </tr>
                <tr>
                    <td class="number"><b>Enter mentor phone number:</b></td>
                ...
                <tr>
                    <td class="txt"><b>Enter mentor experience in years:</b></td>
                ...
                <tr>
                    <td class="txt"><b>Enter Mentor Location:</b></td>
                </tr>
                <tr>
                    <tr>
                        <th>State: </th>
