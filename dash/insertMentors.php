            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Add Mentor</a>
                ...
                <div class="container-fluid">
                    <div class="container-fluid">
                        <?php
                            ...
                            $exp=$_REQUEST['exp'];
                            $table="mentors";
                            $query = "insert into $table(mname,memail,mgender,mstack,mexp,mphone,morg,mdegree,mstate,mcountry,mlinkedin,mdate) values('$name','$email','$gender','$techstack',$exp,'$phone','$organization','$degree','$state','$country','$linkedin',now())";
                            $total="select * from $table where memail='$email'";
                            $count=mysqli_query($connection,$total) or die( mysqli_error($connection)); 
                            $var=mysqli_num_rows($count);
                            if($var>0){
                                echo '<a href="addMentor.php">Mail id already registered...Please select another mail Id!!</a>';
                            }
                            else if(mysqli_query($connection,$query)){
                                echo '<a href="addMentor.php">Successful, Click to go back</a>';
                                $subject = "Mentor Registered successfully - ".$name;
         
                                $message = "<b>Hello ".$name." welcome to VIC, you have been successfully added to our mentorship program under ".$techstack." technology.<br>You will start receiving mentoring requests as soon as users need you.<br>Happy Mentoring!!!! .</b>";
