            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Add Investor</a>
                ...
                <div class="container-fluid">
                    <div class="container-fluid">
                        <?php
                            ...
                            $table="investors";
                            $query = "insert into $table(iname,iemail,igender,iphone,iorg,idegree,icity,istate,idate) values('$name','$email','$gender','$phone','$organization','$degree','$city','$state',now())";
                            $total="select * from $table where iemail='$email'";
                            $count=mysqli_query($connection,$total) or die( mysqli_error($connection)); 
                            $var=mysqli_num_rows($count);
                            if($var>0){
                                echo '<a href="addInvestor.php">Mail id already registered...Please select another mail Id!!</a>';
                            }
                            else if(mysqli_query($connection,$query)){
                                echo '<a href="addInvestor.php">Successful, Click to go back</a>';
                                $subject = "Investor Registered successfully - ".$name;
