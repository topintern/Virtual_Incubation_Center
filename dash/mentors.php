                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Our Mentors</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                    <tbody>
                                        ...
                                        $table="mentors";
                                         ...
                                         $result = mysqli_query($connection,"SELECT * FROM ".$table." order by mdate desc LIMIT $start_from,$limit") or die( mysqli_error($connection));
                                         ...
                                         while ($row = mysqli_fetch_array($result)) {
                                             ...
                                             echo '<td><form action="deleteMentors.php?mid='.$row["mid"].'" method="post"><input type="submit" value="Delete"></form></td>';
                                             echo '</tr>';
                                         }
                                        ?>
                                     </tbody>
