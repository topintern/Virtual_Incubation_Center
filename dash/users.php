                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Our Users</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                        ...
                                        $table="users";
                                         ...
                                         $result = mysqli_query($connection,"SELECT * FROM ".$table." order by udate desc LIMIT $start_from,$limit") or die( mysqli_error($connection));
                                         ...
                                         while ($row = mysqli_fetch_array($result)) {
                                             ...
                                             echo '<td><form action="deleteUser.php?uid='.$row["uid"].'" method="post"><input type="submit" value="Delete"></form></td>';
                                             echo '</tr>';
                                         }
                                        ?>
                                     </tbody>
