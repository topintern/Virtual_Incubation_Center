        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="#"><span class="fa fa-list fa-lg"></span> Public Projects</a></li>
                ...
                <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                    <tbody>
                                        <?php
                                            ...
                                            $result = mysqli_query($connection,"SELECT pid,title,description,project_lead,mailId FROM ".$table." where intended_audience='EveryOne' order by pdate desc LIMIT $start_from,$limit") or die( mysqli_error($connection));
