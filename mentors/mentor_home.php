            ...
            <div class="container wrapper">
                ...
                <table id="dataTablePS" class="table table-striped table-bordered table-hover" style="width:100%">
                    <?php
                        ...
                        $mid=$_SESSION["id"];
                        $result = mysqli_query($connection,"SELECT * FROM ".$table." where pid in (select pid from mentoring_requests where mid=$mid) order by pdate desc LIMIT $start_from,$limit") or die( mysqli_error($connection)); 
                        $page="description"           
                    ?>
                    <thead>
                        <tr class="row-md-24">
